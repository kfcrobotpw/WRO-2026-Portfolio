...
import { Bot, Check, X, Trash2 } from 'lucide-react';
      ...
      <div className="relative w-full max-w-2xl bg-[#08111e] border border-cyan-500/60 rounded-2xl p-6 sm:p-8 shadow-[0_0_40px_rgba(34,211,238,0.25)] space-y-5 max-h-[90vh] overflow-y-auto">
          ...
          <div className="flex items-center gap-2.5">
            ...
            <div>
              <h3 className="text-lg font-bold font-['Orbitron'] text-white">
                {isEditing ? '프로젝트(PROJECT) 수정' : '신규 프로젝트 추가'}
              </h3>
              <p className="text-xs text-slate-400 font-mono">로봇 하드웨어 및 소프트웨어 아카이브</p>
            </div>
          </div>
          <button
            onClick={onClose}
        ...
        <form onSubmit={handleSubmit} className="space-y-4 text-xs font-mono">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
            ...
            <div className="space-y-1">
              <label className="text-slate-300">Blueprint Graphic Type</label>
              <select
